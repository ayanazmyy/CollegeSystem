...
if(isset($_POST['send'])){
    $name = $_POST['name'];
    $insert = "INSERT INTO `doctors` VALUES (Null , '$name')";
...
if(isset($_GET['edit'])){
    ...
    if(isset($_POST['update'])){
        $name = $_POST['name'];
        $update = "UPDATE doctors SET name= '$name' WHERE id= $id";
...
<div class="parent">
<?php if($update) :?>
<h1 class="text-center">Update a professor</h1>
<br>
<?php else :?>
<h1 class="text-center">Add a professor</h1>
<br>
<?php endif ; ?>
